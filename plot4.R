...
names(power) <- c("date", "time", "globalactivepower", "Global_reactive_power", "voltage", "globalintensity",
...
par(mfrow=c(2,2)) #set plots 2x2

#plot 1
plot(globalactivepower ~ datetime, data = power, type = "l", xlab="", ylab = "Global Active Power")

#plot 2
plot(voltage ~ datetime, data = power, type="l", ylab="Voltage")
...
#plot 4
plot(Global_reactive_power ~ datetime, data=power, type="l")
